            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambah-modal">+ Buat Baru</a>                  
                </div>
                <br>
                  {{-- Modal Tambah --}}
                 ...
                 <div class="table-responsive">
                  ...
                  <livewire:admin.agenda.table />
                  <livewire:admin.agenda.delete />
