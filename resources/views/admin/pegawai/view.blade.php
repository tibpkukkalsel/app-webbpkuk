              ...
              <div class="card-body">
                ...
                <br>
                 ...
                 <div class="table-responsive">
                  ...
                  <livewire:admin.pegawai.table />
                  <livewire:admin.pegawai.delete />
...
$(document).on('click','.hapus',function(){
    ...
    Swal.fire({
        ...
        if(result.isConfirmed){
            ...
            Livewire.dispatch('hapusPegawai',{
                id_pegawai:id
            });
