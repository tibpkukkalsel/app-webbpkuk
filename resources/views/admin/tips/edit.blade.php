...
@section('content')
          ...
          <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Tips</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ Route('tips.view')}}">Tips</a>
                      </li>
          ...
          <livewire:admin.tips.edit :id="$id" />
...
document.addEventListener('livewire:init',()=>{
    ...
    Livewire.on('ringkasan-berhasil',()=>{

        Swal.fire({
            icon:'success',
            title:'Berhasil',
            text:'Ringkasan berhasil dibuat oleh AI.',
            timer:1500,
...
document.addEventListener('livewire:init',()=>{
    ...
    Livewire.on('simpan-berhasil',()=>{
        ...
        Swal.fire({
            ...
            window.location="{{ Route('tips.view') }}";
        });
