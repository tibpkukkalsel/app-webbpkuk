...
@section('content')
                ...
                <div class="col-9">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="{{ Route('artikel.view')}}">Artikel</a>
                      </li>
          ...
          <livewire:admin.artikel.edit :id="$id" />
...
$(document).on('click','.hapus-galeri',function(){
    let id=$(this).data('id');
    Swal.fire({
        title:'Hapus foto?', text:'Foto akan dihapus permanen.',
...
document.addEventListener('livewire:init',()=>{
    ...
    const tagify=new Tagify(input,{
        whitelist:window.hashtagList, enforceWhitelist:false, duplicates:false,
