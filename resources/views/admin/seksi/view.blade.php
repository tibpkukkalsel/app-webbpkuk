          ...
          <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Seksi</h4>
              ...
              <div class="card-body">
                ...
                <br>
                 ...
                 <div class="table-responsive">
                  ...
                  <livewire:admin.seksi.table />
                  <livewire:admin.seksi.delete />
...
$(document).on('click','.hapus',function(){
    ...
    Swal.fire({
        ...
        if(result.isConfirmed){
            ...
            Livewire.dispatch('hapusSeksi',{
                id_seksi:id
            });

            Swal.fire({
                title:'Berhasil!',
                text:'Data seksi berhasil dihapus.',
                icon:'success',
                timer:1500,
...
<script>
  document.addEventListener('livewire:init', () => {
      Livewire.on('seksi-created', () => {
          const modalEl = document.getElementById('tambah-modal');
      ...
      Livewire.on('close-edit-modal', () => {
          ...
          Swal.fire({
              title: 'Berhasil!',
              text: 'Data seksi berhasil diperbarui.',
              icon: 'success',
              timer: 1500,
              showConfirmButton: false
          });
