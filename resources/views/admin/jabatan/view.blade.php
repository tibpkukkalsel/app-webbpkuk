...
$(document).on('click','.hapus',function(){
    ...
    Swal.fire({
        ...
        if(result.isConfirmed){
            ...
            Livewire.dispatch('hapusJabatan',{
                id_jabatan:id
            });
