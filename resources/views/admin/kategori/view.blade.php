              ...
              <div class="card-body">
                ...
                <br>
                 ...
                 <div class="table-responsive">
                  ...
                  <livewire:admin.kategori.table />
                  <livewire:admin.kategori.delete />
...
$(document).on('click','.edit',function(){
    ...
    Livewire.dispatch('editKategori',{
        id_kategori:id
    });
...
$(document).on('click','.hapus',function(){
    ...
    Swal.fire({
        ...
        if(result.isConfirmed){
            ...
            Livewire.dispatch('hapusKategori',{
                id_kategori:id
            });
