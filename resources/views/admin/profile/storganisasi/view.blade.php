            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <h4 class="card-title mb-0">Pengelola Struktur Organisasi</h4>
                </div>
                <br>

                 <div class="table-responsive">

                  <livewire:admin.profile.storganisasi.table />
                      ...
                      <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                              <div class="modal-header d-flex align-items-center">
                                  <h4 class="modal-title">Edit Struktur Organisasi</h4>
                                  <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                              </div>

                               <livewire:admin.profile.storganisasi.edit-text />
                  ...
                  <div class="modal fade" id="editfile" tabindex="-1" wire:ignore.self>
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <livewire:admin.profile.storganisasi.edit-file />
                          </div>
                      </div>
                  </div>
                  {{-- End File --}}
