            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                  <h4 class="card-title mb-0">Pengelola Tentang</h4>
                </div>
                <br>

                 <div class="table-responsive">

                  <livewire:admin.profile.tentang.table />
                      ...
                      <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                              <div class="modal-header d-flex align-items-center">
                               ...
                               <livewire:admin.profile.tentang.edit-text />
                  ...
                  <div class="modal fade" id="editfile" tabindex="-1" wire:ignore.self>
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <livewire:admin.profile.tentang.edit-file />
                          </div>
                      </div>
                  </div>
                  {{-- End File --}}
