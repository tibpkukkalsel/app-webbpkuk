              ...
              <div class="card-body">
                ...
                <br>
                  ...
                  <div class="modal fade" id="tambah-modal" tabindex="-1" aria-labelledby="exampleModalLabel1" aria-hidden="true" wire:ignore.self">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <livewire:admin.profile.fasilitas.create />
                        </div>
                    </div>
                  </div>
                  {{-- End Modal Tambah --}}
                 <div class="table-responsive">
                  ...
                  <livewire:admin.profile.fasilitas.table />
                  <livewire:admin.profile.fasilitas.delete />
                  ...
                  <div class="modal fade" id="editdata" tabindex="-1" wire:ignore.self>
                      <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                              ...
                              <livewire:admin.profile.fasilitas.edit />
