...
@section('content')
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Edit Halaman Fasilitas</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Edit Halaman</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
    ...
    <livewire:admin.layanan.fasilitas-halaman.edit :id="$halaman->id_halaman" />
@endsection
