<div>
    ...
    <form @if(!$isReadOnly) wire:submit.prevent="simpan" @endif>
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" wire:model="judul" @if($isReadOnly) disabled @else oninput="jadwalAutoSave()" @endif placeholder="Masukkan judul video...">
                            @error('judul')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" wire:model.live.debounce.500ms="url_youtube" @if($isReadOnly) disabled @else oninput="jadwalAutoSave()" @endif placeholder="Contoh: https://www.youtube.com/watch?v=xxxxxxxx atau https://youtu.be/xxxxxxxx">
                            @error('url_youtube')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" wire:model="id_kategori" @if($isReadOnly) disabled @else onchange="jadwalAutoSave()" @endif>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea rows="5" class="form-control" wire:model="ringkasan" @if($isReadOnly) disabled @else oninput="jadwalAutoSave()" @endif placeholder="Masukkan ringkasan video..."></textarea>
                            @error('ringkasan')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @else
                                <a href="{{ route('video.view') }}" class="btn btn-secondary">
