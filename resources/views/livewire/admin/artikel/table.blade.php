    ...
    <table class="table table-striped table-bordered align-middle">
        ...
        <tbody>
            ...
            <tr wire:key="artikel-{{ md5($d->id_post) }}">
                ...
                @if ($d->status < 2)
                    <a href="{{ route('artikel.edit',$d->id_post) }}" class="btn mb-1 bg-primary-subtle rounded-circle round-40 btn-sm d-inline-flex align-items-center justify-content-center">
