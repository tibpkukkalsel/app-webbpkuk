        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    @if($gambar)
                    <img
                    src="{{ $gambar->temporaryUrl() }}" class="img-fluid rounded border mb-3" style="height:220px;width:100%;object-fit:cover;">
                    @else
                    <img
                    src="{{ asset('storage/layanan/'.$thumbnailLama) }}"class="img-fluid rounded border mb-3" style="height:220px;width:100%;object-fit:cover;">
                    @endif
