        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @elseif($thumbnail)
                        <img src="{{ asset('storage/post/thumbnail/'.$thumbnail) }}" class="img-fluid rounded border mb-3" style="height:220px;width:100%;object-fit:cover;">
                    @else
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    window.selectedHashtag=@json(
                        $hashtagPost->pluck('hashtag')
                    );
                    </script>
                </div>
            </div>
